//importar biblioteca java.util 
import java.util.*;
//importar biblioteca java.sql 
import java.sql.*;
//declaração de classe\objeto Update1MySQL
public class Update1MySQL {
     ...
     * @param thrso Expection - indicando que o método pode lançar qualquer exceção que seja uma subclasse de Exception
     */
    public static void main(String[] args) throws Exception {
        //utilizado para limpar o console.
        System.out.print("\033[H\033[2J");
        //usado para forçar a saída padrão (System.out) a ser imediatamente escrita no dispositivo de saída, como o console. 
        System.out.flush();
